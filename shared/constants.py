...
NO_JETPACK, JETPACK_NORMAL, JETPACK2, JETPACK_ENGINEER, JETPACK_UGCBUILDER = xrange(NOOF_SELECTABLE_TOOLS, NOOF_SELECTABLE_TOOLS + NUM_JETPACK)
A363 = NO_JETPACK
A364 = JETPACK_NORMAL
A365 = JETPACK2
...
# NO IDEA WTF
A368 = 2
A369, A370 = xrange(NO_JETPACK + NUM_JETPACK + 1, NO_JETPACK + NUM_JETPACK + 1 + A368)
#
...
CLASS_PREFABS_SOLDIER, CLASS_PREFABS_SCOUT, CLASS_PREFABS_ROCKETEER, CLASS_PREFABS_MINER, CLASS_PREFABS_ZOMBIE, CLASS_PREFABS_CLASSIC_SOLDIER, CLASS_PREFABS_GANGSTER, DEFAULT_PREFABS, MAP_PREFABS, CLASS_PREFABS_ENGINEER, CLASS_PREFABS_UGCBUILDER, CLASS_PREFABS_FAST_ZOMBIE, CLASS_PREFABS_JUMP_ZOMBIE, CLASS_PREFABS_SPECIALIST, CLASS_PREFABS_MEDIC = xrange(15)
...
UGC_ITEM_HEALTH_DROP_POINT, UGC_ITEM_AMMO_DROP_POINT, UGC_ITEM_BLOCK_DROP_POINT, UGC_ITEM_OCC_BOMB_POINT, UGC_ITEM_GREEN_SPAWN_ZONE_SMALL, UGC_ITEM_GREEN_SPAWN_ZONE_MEDIUM, UGC_ITEM_GREEN_SPAWN_ZONE_LARGE, UGC_ITEM_BLUE_SPAWN_ZONE_SMALL, UGC_ITEM_BLUE_SPAWN_ZONE_MEDIUM, UGC_ITEM_BLUE_SPAWN_ZONE_LARGE, UGC_ITEM_GREEN_BASE_ZONE_SMALL, UGC_ITEM_GREEN_BASE_ZONE_MEDIUM, UGC_ITEM_GREEN_BASE_ZONE_LARGE, UGC_ITEM_BLUE_BASE_ZONE_SMALL, UGC_ITEM_BLUE_BASE_ZONE_MEDIUM, UGC_ITEM_BLUE_BASE_ZONE_LARGE, UGC_ITEM_NEUTRAL_BASE_ZONE_SMALL, UGC_ITEM_NEUTRAL_BASE_ZONE_MEDIUM, UGC_ITEM_NEUTRAL_BASE_ZONE_LARGE = xrange(19)
...
UGC_GROUP_DROP_POINT, UGC_GROUP_GREEN_SPAWN_ZONE, UGC_GROUP_BLUE_SPAWN_ZONE, UGC_GROUP_GREEN_BASE, UGC_GROUP_BLUE_BASE, UGC_GROUP_NEUTRAL_BASE = xrange(6)
...
CLASS_UGCTOOLS_UGCBUILDER = xrange(1)
...
CLASS_MELEE, CLASS_PRIMARY_WEAPONS, CLASS_SECONDARY_WEAPONS, CLASS_EQUIPMENT, CLASS_PREFABS, CLASS_COMMON, CLASS_UGC_TOOLS, CLASS_NOOF_ITEMS = xrange(8)
A515 = CLASS_MELEE
...
BAN_NONE, BAN_TEMPORARY, BAN_PERMANENT = xrange(3)
A877 = BAN_NONE
A878 = BAN_TEMPORARY
A879 = BAN_PERMANENT
...
FLY_CAMERA, CHASE_CAMERA, TANK_CAMERA, PAN_CAMERA, LOOKAT_CAMERA, DEATH_CAMERA, UGCPREFAB_CAMERA = xrange(7)
A986 = FLY_CAMERA
A987 = CHASE_CAMERA
A988 = TANK_CAMERA
A989 = PAN_CAMERA
...
UGC_CONVERT_TO_GAME, UGC_REQUEST_MAP_VALIDATION, UGC_REQUEST_VXL, UGC_NO_VXL_USE_BASEPLATE, UGC_REQUEST_MAPINFO = xrange(5)
...
MAP_IS_NOT_UGC, MAP_IS_UGC_HOST, MAP_IS_UGC_CLIENT = xrange(3)
A2015 = MAP_IS_NOT_UGC
A2016 = MAP_IS_UGC_HOST
A2017 = MAP_IS_UGC_CLIENT

#WTF
for ugc_zone_key, ugc_zone_size in UGC_ZONE_SIZES.iteritems():
...
UGC_ZONE_TYPE_SPAWN1, UGC_ZONE_TYPE_SPAWN2, UGC_ZONE_TYPE_BASE1, UGC_ZONE_TYPE_BASE2, UGC_ZONE_TYPE_BASE = xrange(5)
...
#Orientations
FORWARD_ORIENTATION_PITCH, UP_ORIENTATION_PITCH, BACK_ORIENTATION_PITCH, DOWN_ORIENTATION_PITCH, NOOF_ORIENTATION_PITCHES = xrange(5)
...
TOP_FACES_UP_ORIENTATION_ROLL, TOP_FACES_LEFT_ORIENTATION_ROLL, TOP_FACES_BOTTOM_ORIENTATION_ROLL, TOP_FACES_RIGHT_ORIENTATION_ROLL, NOOF_ORIENTATION_ROLLS = xrange(5)
...
PREFAB_CONSTANT_DISTANCE_FROM_PLAYER, PREFAB_SCALED_DISTANCE_FROM_PLAYER, PREFAB_MIN_DISTANCE_FROM_PLAYER, PREFAB_MAX_DISTANCE_FROM_PLAYER = xrange(4)
